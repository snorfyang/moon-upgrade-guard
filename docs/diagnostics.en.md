...
This page lists 41 codes and is generated from `diagnostic.mbt` by `scripts/gen_diagnostics_doc.py`. CI regenerates it and fails when the committed copy differs, so a new code cannot ship undocumented.
